...
class Index:
    ...
    def search(self, term):
        ...
        if term in self.index:
            msgs = [(i, self.msgs[i] ) for i in self.index[term] ]
        else:
...
class PIndex(Index):
    ...
    def load_poems(self):
        ...
        # ---- start your code ---- #
        pass
        lines = open(self.name).readlines()
        for l in lines:
    ...
    def get_poem(self, p):
        ...
        # ---- start your code ---- #
        pass
        start_word = self.int2roman[p] + '.'
        end_word = self.int2roman[p+1] + '.'
        # TODO: CAUTION! OVERSIZE 
        start = self.search(start_word)[0][0]
        print(start)
        end = self.search(end_word)[0][0]
